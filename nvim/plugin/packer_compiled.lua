...
_G.packer_plugins = {
  ...
  neogit = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/neogit",
  ...
  neorg = {
    ...
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/neorg",
  ...
  ["nvim-test"] = {
    ...
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/nvim-test",
  ...
  ["nvim-treesitter-pyfold"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/nvim-treesitter-pyfold",
